...
public class ContactAdapter extends ArrayAdapter<Contact> implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtname = (TextView) personView.findViewById(R.id.txtName);
    ...
    public void sortContacts(final int position){
        super.sort(new Comparator<Contact>() {
            ...
            public int compare(Contact contact, Contact t1) {
                if(position==0) {
                    return contact.Name.toUpperCase().compareTo(t1.Name.toUpperCase());
                }
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (Contact contact : originalContacts) {
                    if (contact.Name.toUpperCase().startsWith(constraint.toString().toUpperCase()))
